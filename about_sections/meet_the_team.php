<section id="meet_the_team" class="about-section">
	<div class="max-container top-bottom-padding">
		<h2>
			meet our team
		</h2>
		...
		<div class="team-members">
			<ul>
				<?php for($i=0; $i < 4; $i++) { ?>
				<li>
					<img src="/wp-content/themes/hunter_dunning/images/male_image.png">
					<ul>
				...
				<li>
					<img src="/wp-content/themes/hunter_dunning/images/female_image.png">
					<ul>
